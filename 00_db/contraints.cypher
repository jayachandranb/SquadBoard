...
CREATE CONSTRAINT ON (sq:Squad) ASSERT sq.squadID IS UNIQUE;
CREATE CONSTRAINT ON (f:Focus) ASSERT f.area IS UNIQUE;
CREATE CONSTRAINT ON (f:Focus) ASSERT f.focusID IS UNIQUE;
...
CREATE CONSTRAINT ON (c:Chapter) ASSERT c.chapterID IS UNIQUE;
CREATE CONSTRAINT ON (sk:Skill) ASSERT sk.expertise IS UNIQUE;
CREATE CONSTRAINT ON (sk:Skill) ASSERT sk.skillID IS UNIQUE;
CREATE CONSTRAINT ON (b:Badge) ASSERT b.name IS UNIQUE;
CREATE CONSTRAINT ON (b:Badge) ASSERT b.badgeID IS UNIQUE;
...
CREATE CONSTRAINT ON (o:Organisation) ASSERT o.shortName IS UNIQUE;
CREATE CONSTRAINT ON (o:Organisation) ASSERT o.organisationID IS UNIQUE;
